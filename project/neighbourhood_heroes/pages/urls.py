...
urlpatterns = [
    ...
    path('view-new-tasks', views.NewTaskList.as_view()),
    path('view-new-tasks/<int:pk>', views.NewTaskDetail.as_view()),
    path('view-tasks/<int:pk>/class-view', views.TaskUpdate.as_view(), name='update-specific-task'),
